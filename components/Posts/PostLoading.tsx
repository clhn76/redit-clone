export default function PostLoading() {
  return (
    <div className="flex flex-col gap-2 mt-4">
      <div
        role="status"
        className="w-full p-4 bg-white rounded shadow animate-pulse md:p-6 dark:border-gray-500"
      >
        ...
        <div className="mt-2 flex items-center justify-center h-48 mb-4 bg-gray-300 rounded dark:bg-gray-400">
          <svg
